...
func (logging *LocalLogging) SetRequestInputLogger(httpHeader *httphandler.HttpHeaderInfo, httpReq *httphandler.HttpRequestParamInfo, appConfig *config.Config, bReq []byte, tStartTime time.Time) {
...
func (logging *LocalLoggingLegacy) SetLegacyInputLoggerStart(uuid string, tagsEnv string, tagsApp string, tStartTime time.Time) {
	logging.uuid = uuid
